    ...
    private <IS> TypeRewriteRule cap(Type<IS> p_15427_) {
        ...
        return this.fixTypeEverywhereTyped(
            ...
            p_326574_ -> {
                ...
                Dynamic<?> dynamic = p_326574_.getOrCreate(DSL.remainderFinder());
                ...
                return p_326574_.set(opticfinder, type1, Pair.of(either, Pair.of(either1, Pair.of(either2, dynamic))));
            }
        );
    }
}