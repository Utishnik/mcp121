                                ...
                                p_145530_ -> p_145530_.updateTyped(
                                            ...
                                            p_145533_ -> p_145533_.update(
                                                    ...
                                                    p_145544_ -> p_145544_.stream()
                                                            ...
                                                            .map(
                                                                p_145535_ -> p_145535_.mapFirst(
                                                                        p_145542_ -> p_145542_.equals("New_Village") ? "Village" : p_145542_
                                                                    )
                                                            )
                                            ...
                                            p_145550_ -> p_145550_.update(
                                                    ...
                                                    p_145552_ -> {
                                                        ...
                                                        return DataFixUtils.orElse(
                                                                optional.map(p_145540_ -> p_145552_.remove("New_Village").set("Village", (Dynamic<?>)p_145540_)),
                                                                p_145552_
                                                            )
                                                            .remove("Village");
                                                    }
