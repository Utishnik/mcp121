    ...
    public TypeRewriteRule makeRule() {
        return this.fixTypeEverywhereTyped(
            ...
            p_16633_ -> p_16633_.update(
                    DSL.remainderFinder(),
                    p_326635_ -> p_326635_.getMapValues().map(p_145578_ -> p_326635_.createMap(p_145578_.entrySet().stream().map(p_145580_ -> {
                            ...
                            }).collect(Collectors.toMap(Pair::getFirst, Pair::getSecond)))).result().orElse((Dynamic)p_326635_)
                )
        );
    }
}
