...
public class ItemStackEnchantmentNamesFix extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped(
            ...
            type,
            p_16069_ -> p_16069_.updateTyped(opticfinder, p_145419_ -> p_145419_.update(DSL.remainderFinder(), this::fixTag))
        );
    }
        ...
        return p_16073_.update(
            ...
            p_326597_ -> DataFixUtils.orElse(
                    p_326597_.asStreamOpt()
                        .map(
                            p_145421_ -> p_145421_.map(
                                    p_145423_ -> p_145423_.set("id", p_145423_.createString(MAP.getOrDefault(p_145423_.get("id").asInt(0), "null")))
                                )
                        )
                        .map(p_326597_::createList)
                        .result(),
                    p_326597_
                )
        );
