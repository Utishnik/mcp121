...
public class EntityIdFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return TypeRewriteRule.seq(
            this.convertUnchecked("item stack entity name hook converter", type, type1),
            this.fixTypeEverywhere(
                "EntityIdFix",
                taggedchoicetype,
                taggedchoicetype1,
                p_15461_ -> p_145282_ -> p_145282_.mapFirst(p_145284_ -> ID_MAP.getOrDefault(p_145284_, p_145284_))
            )
        );
    }
}