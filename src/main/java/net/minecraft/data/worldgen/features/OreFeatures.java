...
public class OreFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> p_329682_) {
        ...
        List<OreConfiguration.TargetBlockState> list = List.of(
            OreConfiguration.target(ruletest1, Blocks.IRON_ORE.defaultBlockState()), OreConfiguration.target(ruletest2, Blocks.DEEPSLATE_IRON_ORE.defaultBlockState())
        );
        List<OreConfiguration.TargetBlockState> list1 = List.of(
            OreConfiguration.target(ruletest1, Blocks.GOLD_ORE.defaultBlockState()), OreConfiguration.target(ruletest2, Blocks.DEEPSLATE_GOLD_ORE.defaultBlockState())
        );
        List<OreConfiguration.TargetBlockState> list2 = List.of(
            OreConfiguration.target(ruletest1, Blocks.DIAMOND_ORE.defaultBlockState()), OreConfiguration.target(ruletest2, Blocks.DEEPSLATE_DIAMOND_ORE.defaultBlockState())
        );
        List<OreConfiguration.TargetBlockState> list3 = List.of(
            OreConfiguration.target(ruletest1, Blocks.LAPIS_ORE.defaultBlockState()), OreConfiguration.target(ruletest2, Blocks.DEEPSLATE_LAPIS_ORE.defaultBlockState())
        );
        List<OreConfiguration.TargetBlockState> list4 = List.of(
            OreConfiguration.target(ruletest1, Blocks.COPPER_ORE.defaultBlockState()), OreConfiguration.target(ruletest2, Blocks.DEEPSLATE_COPPER_ORE.defaultBlockState())
        );
        ...
        FeatureUtils.register(
            ...
            new OreConfiguration(
                List.of(OreConfiguration.target(ruletest1, Blocks.REDSTONE_ORE.defaultBlockState()), OreConfiguration.target(ruletest2, Blocks.DEEPSLATE_REDSTONE_ORE.defaultBlockState())),
                8
            )
        );
        ...
        FeatureUtils.register(
            ...
            Feature.ORE,
            new OreConfiguration(
                List.of(OreConfiguration.target(ruletest1, Blocks.INFESTED_STONE.defaultBlockState()), OreConfiguration.target(ruletest2, Blocks.INFESTED_DEEPSLATE.defaultBlockState())),
                9
            )
        );
        FeatureUtils.register(
            ...
            Feature.ORE,
            new OreConfiguration(
                List.of(OreConfiguration.target(ruletest1, Blocks.EMERALD_ORE.defaultBlockState()), OreConfiguration.target(ruletest2, Blocks.DEEPSLATE_EMERALD_ORE.defaultBlockState())),
                3
            )
        );
