...
public class BiomeDefaultFeatures {
    ...
    public static void addDefaultOres(BiomeGenerationSettings.Builder p_194723_, boolean p_194724_) {
        ...
        p_194723_.addFeature(GenerationStep.Decoration.UNDERGROUND_ORES, OrePlacements.ORE_DIAMOND_MEDIUM);
    ...
    public static void commonSpawns(MobSpawnSettings.Builder p_343832_, int p_345363_) {
        caveSpawns(p_343832_);
        monsters(p_343832_, 95, 5, p_345363_, false);
    }
