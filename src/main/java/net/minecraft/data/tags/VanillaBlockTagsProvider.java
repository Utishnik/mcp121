...
public class VanillaBlockTagsProvider extends IntrinsicHolderTagsProvider<Block> {
    ...
    protected void addTags(HolderLookup.Provider p_255662_) {
        ...
        this.tag(BlockTags.FLOWERS)
            ...
            .add(Blocks.FLOWERING_AZALEA_LEAVES, Blocks.FLOWERING_AZALEA, Blocks.MANGROVE_PROPAGULE, Blocks.CHERRY_LEAVES, Blocks.PINK_PETALS, Blocks.CHORUS_FLOWER, Blocks.SPORE_BLOSSOM);
        ...
        p_255662_.lookupOrThrow(Registries.BLOCK).filterElements(p_284651_ -> p_284651_.defaultBlockState().canBeReplaced()).listElementIds().forEach(intrinsictagappender::add);
