...
public class BlockModelGenerators {
                                    ...
                                    return Variant.variant()
                                        .with(
                                            ...
                                            ModelTemplates.CUBE_ALL
                                                .createWithSuffix(
                                                    p_277651_, s, new TextureMapping().put(TextureSlot.ALL, resourcelocation), this.modelOutput
                                                )
                                        );
                                }
                            )
    ...
    static BlockStateGenerator createWall(Block p_124839_, ResourceLocation p_124840_, ResourceLocation p_124841_, ResourceLocation p_124842_) {
        return MultiPartGenerator.multiPart(p_124839_)
            .with(
                Condition.condition().term(BlockStateProperties.UP, true), Variant.variant().with(VariantProperties.MODEL, p_124840_)
            )
            .with(
            ...
            .with(
                PropertyDispatch.properties(BlockStateProperties.HORIZONTAL_FACING, BlockStateProperties.HALF, BlockStateProperties.OPEN)
                    ...
                    .select(
                        ...
                        false,
                        Variant.variant()
                            .with(VariantProperties.MODEL, p_124891_)
                            .with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)
                    )
                    .select(
                        Direction.EAST,
                    ...
                    .select(
                        ...
                        false,
                        Variant.variant()
                            .with(VariantProperties.MODEL, p_124890_)
                            .with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)
                    )
                    .select(
                        Direction.EAST,
            ...
            .with(
                PropertyDispatch.properties(BlockStateProperties.HORIZONTAL_FACING, BlockStateProperties.HALF, BlockStateProperties.OPEN)
                    ...
                    .select(
                        ...
                        true,
                        Variant.variant()
                            .with(VariantProperties.MODEL, p_124912_)
                            .with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)
                    )
                    .select(
                        Direction.EAST,
    ...
    private void createHorizontallyRotatedBlock(Block p_124745_, TexturedModel.Provider p_124746_) {
        ...
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.multiVariant(p_124745_, Variant.variant().with(VariantProperties.MODEL, resourcelocation)).with(createHorizontalFacingDispatch())
            );
    }
                        ...
                        PropertyDispatch.property(BlockStateProperties.AGE_7)
                            .generate(
                                p_176108_ -> Variant.variant()
                                        .with(
                                            VariantProperties.MODEL,
                                            ModelTemplates.STEMS[p_176108_].create(p_124789_, texturemapping, this.modelOutput)
                                        )
                            )
                    )
            );
    ...
    private void createPitcherCrop() {
        ...
        PropertyDispatch propertydispatch = PropertyDispatch.properties(PitcherCropBlock.AGE, BlockStateProperties.DOUBLE_BLOCK_HALF)
            .generate((p_325897_, p_325898_) -> {
                return switch (p_325898_) {
                    case UPPER -> Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(block, "_top_stage_" + p_325897_));
                    case LOWER -> Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(block, "_bottom_stage_" + p_325897_));
                };
            });
    ...
    private void createPumpkinVariant(Block p_124565_, TextureMapping p_124566_) {
        ...
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.multiVariant(p_124565_, Variant.variant().with(VariantProperties.MODEL, resourcelocation)).with(createHorizontalFacingDispatch())
            );
    }
    ...
    private BlockStateGenerator createCopperBulb(
        Block p_309677_, ResourceLocation p_309526_, ResourceLocation p_310659_, ResourceLocation p_310780_, ResourceLocation p_309762_
    ) {
        return MultiVariantGenerator.multiVariant(p_309677_)
            .with(
                PropertyDispatch.properties(BlockStateProperties.LIT, BlockStateProperties.POWERED)
                    .generate(
                        (p_308505_, p_308506_) -> p_308505_
                                ? Variant.variant().with(VariantProperties.MODEL, p_308506_ ? p_309762_ : p_310659_)
                                : Variant.variant().with(VariantProperties.MODEL, p_308506_ ? p_310780_ : p_309526_)
                    )
            );
    }
        ...
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.multiVariant(
                        ...
                        Variant.variant()
                            .with(
                                VariantProperties.MODEL, ModelTemplates.CROSS.create(p_176252_, TextureMapping.cross(p_176252_), this.modelOutput)
                            )
                    )
                    .with(this.createColumnWithFacing())
            );
    ...
    private static List<Variant> wrapModels(List<ResourceLocation> p_124683_, UnaryOperator<Variant> p_124684_) {
        return p_124683_.stream()
            .map(p_176238_ -> Variant.variant().with(VariantProperties.MODEL, p_176238_))
            .map(p_124684_)
            .collect(Collectors.toList());
    }
            ...
            .accept(
                MultiPartGenerator.multiPart(Blocks.FIRE)
                    ...
                    .with(
                        ...
                        wrapModels(list1, p_176243_ -> p_176243_)
                    )
                    .with(
    ...
    private void createLantern(Block p_125005_) {
        ...
        this.blockStateOutput
            .accept(MultiVariantGenerator.multiVariant(p_125005_).with(createBooleanModelDispatch(BlockStateProperties.HANGING, resourcelocation1, resourcelocation)));
    }
    ...
    private void createWeightedPressurePlate(Block p_124919_, Block p_124920_) {
        ...
        this.blockStateOutput
            .accept(MultiVariantGenerator.multiVariant(p_124919_).with(createEmptyOrFullDispatch(BlockStateProperties.POWER, 1, resourcelocation1, resourcelocation)));
    }
                ...
                MultiVariantGenerator.multiVariant(block)
                    .with(
                        PropertyDispatch.properties(BlockStateProperties.TRIAL_SPAWNER_STATE, BlockStateProperties.OMINOUS)
                            .generate(
                                (p_325891_, p_325892_) -> {
                                    return switch (p_325891_) {
                                        case INACTIVE, COOLDOWN -> Variant.variant()
                                        .with(VariantProperties.MODEL, p_325892_ ? resourcelocation3 : resourcelocation);
                                        case WAITING_FOR_PLAYERS, ACTIVE, WAITING_FOR_REWARD_EJECTION -> Variant.variant()
                                        .with(VariantProperties.MODEL, p_325892_ ? resourcelocation4 : resourcelocation1);
                                        case EJECTING_REWARD -> Variant.variant()
                                        .with(VariantProperties.MODEL, p_325892_ ? resourcelocation5 : resourcelocation2);
                                    };
                                }
                            )
                    )
    ...
    private void createVault() {
        ...
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.multiVariant(block)
                    .with(createHorizontalFacingDispatch())
                    .with(PropertyDispatch.properties(VaultBlock.STATE, VaultBlock.OMINOUS).generate((p_325883_, p_325884_) -> {
                        return switch (p_325883_) {
                            case INACTIVE -> Variant.variant().with(VariantProperties.MODEL, p_325884_ ? resourcelocation4 : resourcelocation);
                            case ACTIVE -> Variant.variant().with(VariantProperties.MODEL, p_325884_ ? resourcelocation5 : resourcelocation1);
                            case UNLOCKING -> Variant.variant().with(VariantProperties.MODEL, p_325884_ ? resourcelocation6 : resourcelocation2);
                            case EJECTING -> Variant.variant().with(VariantProperties.MODEL, p_325884_ ? resourcelocation7 : resourcelocation3);
                        };
                    }))
            );
    }
        ...
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.multiVariant(
                        p_124952_,
                        Variant.variant()
                            .with(VariantProperties.MODEL, ModelTemplates.WALL_TORCH.create(p_124952_, texturemapping, this.modelOutput))
                    )
                ...
                MultiVariantGenerator.multiVariant(Blocks.REPEATER)
                    .with(
                        PropertyDispatch.properties(BlockStateProperties.DELAY, BlockStateProperties.LOCKED, BlockStateProperties.POWERED)
                            .generate((p_176134_, p_176135_, p_176136_) -> {
                                StringBuilder stringbuilder = new StringBuilder();
                                stringbuilder.append('_').append(p_176134_).append("tick");
                                if (p_176136_) {
                        ...
                        PropertyDispatch.property(BlockStateProperties.STRUCTUREBLOCK_MODE)
                            .generate(
                                p_176115_ -> Variant.variant()
                                        .with(
                                            VariantProperties.MODEL,
                                            this.createSuffixedVariant(Blocks.STRUCTURE_BLOCK, "_" + p_176115_.getSerializedName(), ModelTemplates.CUBE_ALL, TextureMapping::cube)
                                        )
                            )
                    )
            );
                        ...
                        PropertyDispatch.property(BlockStateProperties.AGE_3)
                            .generate(
                                p_176132_ -> Variant.variant()
                                        .with(
                                            VariantProperties.MODEL,
                                            this.createSuffixedVariant(Blocks.SWEET_BERRY_BUSH, "_stage" + p_176132_, ModelTemplates.CROSS, TextureMapping::cross)
                                        )
                            )
                    )
            );
                ...
                MultiVariantGenerator.multiVariant(Blocks.SCULK_CATALYST)
                    .with(
                        PropertyDispatch.property(BlockStateProperties.BLOOM)
                            .generate(
                                p_236280_ -> Variant.variant().with(VariantProperties.MODEL, p_236280_ ? resourcelocation2 : resourcelocation1)
                            )
                    )
            );
    ...
    private void createChiseledBookshelf() {
        ...
        List.of(
            ...
            .forEach(
                p_325895_ -> {
                    Direction direction = p_325895_.getFirst();
                    VariantProperties.Rotation variantproperties$rotation = p_325895_.getSecond();
    ...
    private void addBookSlotModel(
        MultiPartGenerator p_261839_,
        Condition.TerminalCondition p_261634_,
        VariantProperties.Rotation p_262044_,
        BooleanProperty p_262163_,
        ModelTemplate p_261986_,
        boolean p_261790_
    ) {
        ...
        ResourceLocation resourcelocation = CHISELED_BOOKSHELF_SLOT_MODEL_CACHE.computeIfAbsent(
            blockmodelgenerators$bookslotmodelcachekey, p_261415_ -> p_261986_.createWithSuffix(Blocks.CHISELED_BOOKSHELF, s, texturemapping, this.modelOutput)
        );
        p_261839_.with(
            Condition.and(p_261634_, Condition.condition().term(p_262163_, p_261790_)),
            Variant.variant().with(VariantProperties.MODEL, resourcelocation).with(VariantProperties.Y_ROT, p_262044_)
        );
    }
        ...
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.multiVariant(Blocks.JIGSAW, Variant.variant().with(VariantProperties.MODEL, resourcelocation4))
                    .with(PropertyDispatch.property(BlockStateProperties.ORIENTATION).generate(p_308500_ -> this.applyRotation(p_308500_, Variant.variant())))
            );
    }
    ...
    public void run() {
        BlockFamilies.getAllFamilies().filter(BlockFamily::shouldGenerateModel).forEach(p_236303_ -> this.family(p_236303_.getBaseBlock()).generateFor(p_236303_));
        ...
        this.blockEntityModels(ModelLocationUtils.decorateBlockModelLocation("skull"), Blocks.SOUL_SAND)
            .createWithCustomBlockItemModel(ModelTemplates.SKULL_INVENTORY, Blocks.CREEPER_HEAD, Blocks.PLAYER_HEAD, Blocks.ZOMBIE_HEAD, Blocks.SKELETON_SKULL, Blocks.WITHER_SKELETON_SKULL, Blocks.PIGLIN_HEAD)
            .create(Blocks.DRAGON_HEAD)
            .createWithoutBlockItem(Blocks.CREEPER_WALL_HEAD, Blocks.DRAGON_WALL_HEAD, Blocks.PLAYER_WALL_HEAD, Blocks.ZOMBIE_WALL_HEAD, Blocks.SKELETON_WALL_SKULL, Blocks.WITHER_SKELETON_WALL_SKULL, Blocks.PIGLIN_WALL_HEAD);
    ...
    private void createCandleAndCandleCake(Block p_176245_, Block p_176246_) {
        ...
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.multiVariant(p_176245_)
                    .with(
        ...
        this.blockStateOutput
            .accept(MultiVariantGenerator.multiVariant(p_176246_).with(createBooleanModelDispatch(BlockStateProperties.LIT, resourcelocation9, resourcelocation8)));
    }

    class BlockEntityModelGenerator {
        private final ResourceLocation baseModel;

        public BlockEntityModelGenerator(final ResourceLocation p_125020_, final Block p_125021_) {
    ...
    class BlockFamilyProvider {
        ...
        public BlockFamilyProvider(final TextureMapping p_125034_) {
                ...
                BlockModelGenerators.this.blockStateOutput
                    .accept(
                        BlockModelGenerators.this.fullBlockModelCustomGenerators
                            .get(p_125041_)
                            .create(p_125041_, this.fullBlock, this.mapping, BlockModelGenerators.this.modelOutput)
                    );
            } else {
        ...
        public BlockModelGenerators.BlockFamilyProvider customFence(Block p_250333_) {
            ...
            BlockModelGenerators.this.blockStateOutput
                .accept(BlockModelGenerators.createCustomFence(p_250333_, resourcelocation, resourcelocation1, resourcelocation2, resourcelocation3, resourcelocation4));
        ...
        public BlockModelGenerators.BlockFamilyProvider customFenceGate(Block p_248640_) {
            ...
            BlockModelGenerators.this.blockStateOutput
                .accept(BlockModelGenerators.createFenceGate(p_248640_, resourcelocation, resourcelocation1, resourcelocation2, resourcelocation3, false));
            return this;
        }
        ...
        public BlockModelGenerators.BlockFamilyProvider fenceGate(Block p_125050_) {
            ...
            BlockModelGenerators.this.blockStateOutput
                .accept(BlockModelGenerators.createFenceGate(p_125050_, resourcelocation, resourcelocation1, resourcelocation2, resourcelocation3, true));
            return this;
        }
        ...
        private ResourceLocation getOrCreateModel(ModelTemplate p_176262_, Block p_176263_) {
            return this.models.computeIfAbsent(p_176262_, p_176268_ -> p_176268_.create(p_176263_, this.mapping, BlockModelGenerators.this.modelOutput));
        }
    ...
    interface BlockStateGeneratorSupplier {
        BlockStateGenerator create(
            Block p_176278_, ResourceLocation p_176279_, TextureMapping p_176280_, BiConsumer<ResourceLocation, Supplier<JsonElement>> p_176281_
        );
    }
    ...
    class WoodProvider {
        ...
        public WoodProvider(final TextureMapping p_125073_) {
