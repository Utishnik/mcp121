...
public class TextureMapping {
    ...
    public static TextureMapping column(Block p_125819_) {
        return new TextureMapping()
            .put(TextureSlot.SIDE, getBlockTexture(p_125819_, "_side"))
            .put(TextureSlot.END, getBlockTexture(p_125819_, "_top"));
    }

    public static TextureMapping cubeTop(Block p_125823_) {
        return new TextureMapping()
            .put(TextureSlot.SIDE, getBlockTexture(p_125823_, "_side"))
            .put(TextureSlot.TOP, getBlockTexture(p_125823_, "_top"));
    }
    ...
    public static TextureMapping door(Block p_125833_) {
        return new TextureMapping()
            .put(TextureSlot.TOP, getBlockTexture(p_125833_, "_top"))
            .put(TextureSlot.BOTTOM, getBlockTexture(p_125833_, "_bottom"));
    }
    ...
    public static TextureMapping trialSpawner(Block p_313123_, String p_310566_, String p_310636_) {
        return new TextureMapping()
            .put(TextureSlot.SIDE, getBlockTexture(p_313123_, p_310566_))
            .put(TextureSlot.TOP, getBlockTexture(p_313123_, p_310636_))
            .put(TextureSlot.BOTTOM, getBlockTexture(p_313123_, "_bottom"));
    }

    public static TextureMapping vault(Block p_333345_, String p_331131_, String p_329704_, String p_331473_, String p_328340_) {
        return new TextureMapping()
            .put(TextureSlot.FRONT, getBlockTexture(p_333345_, p_331131_))
            .put(TextureSlot.SIDE, getBlockTexture(p_333345_, p_329704_))
            .put(TextureSlot.TOP, getBlockTexture(p_333345_, p_331473_))
            .put(TextureSlot.BOTTOM, getBlockTexture(p_333345_, p_328340_));
    }
    ...
    public static TextureMapping campfire(Block p_125737_) {
        return new TextureMapping()
            .put(TextureSlot.LIT_LOG, getBlockTexture(p_125737_, "_log_lit"))
            .put(TextureSlot.FIRE, getBlockTexture(p_125737_, "_fire"));
    }
    ...
    public static TextureMapping layered(ResourceLocation p_268096_, ResourceLocation p_268084_, ResourceLocation p_268063_) {
        return new TextureMapping()
            .put(TextureSlot.LAYER0, p_268096_)
            .put(TextureSlot.LAYER1, p_268084_)
            .put(TextureSlot.LAYER2, p_268063_);
    }
