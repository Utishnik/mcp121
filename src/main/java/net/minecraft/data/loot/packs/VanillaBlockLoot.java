...
public class VanillaBlockLoot extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(Blocks.TUFF_SLAB, p_251629_ -> this.createSlabItemTable(p_251629_));
        this.add(Blocks.TUFF_BRICK_SLAB, p_251237_ -> this.createSlabItemTable(p_251237_));
        this.add(Blocks.POLISHED_TUFF_SLAB, p_249031_ -> this.createSlabItemTable(p_249031_));
        ...
        this.add(Blocks.GRASS_BLOCK, p_249779_ -> this.createSingleItemTableWithSilkTouch(p_249779_, Blocks.DIRT));
        this.add(Blocks.PODZOL, p_250966_ -> this.createSingleItemTableWithSilkTouch(p_250966_, Blocks.DIRT));
        this.add(Blocks.MYCELIUM, p_250352_ -> this.createSingleItemTableWithSilkTouch(p_250352_, Blocks.DIRT));
        ...
        this.add(Blocks.OAK_SLAB, p_249325_ -> this.createSlabItemTable(p_249325_));
        this.add(Blocks.PETRIFIED_OAK_SLAB, p_249953_ -> this.createSlabItemTable(p_249953_));
        this.add(Blocks.SPRUCE_SLAB, p_251725_ -> this.createSlabItemTable(p_251725_));
        this.add(Blocks.BIRCH_SLAB, p_248946_ -> this.createSlabItemTable(p_248946_));
        this.add(Blocks.JUNGLE_SLAB, p_249873_ -> this.createSlabItemTable(p_249873_));
        this.add(Blocks.ACACIA_SLAB, p_250611_ -> this.createSlabItemTable(p_250611_));
        this.add(Blocks.DARK_OAK_SLAB, p_250363_ -> this.createSlabItemTable(p_250363_));
        ...
        this.add(Blocks.BAMBOO_MOSAIC_SLAB, p_251560_ -> this.createSlabItemTable(p_251560_));
        this.add(Blocks.BRICK_SLAB, p_250571_ -> this.createSlabItemTable(p_250571_));
        this.add(Blocks.COBBLESTONE_SLAB, p_250698_ -> this.createSlabItemTable(p_250698_));
        this.add(Blocks.DARK_PRISMARINE_SLAB, p_250985_ -> this.createSlabItemTable(p_250985_));
        this.add(Blocks.NETHER_BRICK_SLAB, p_250829_ -> this.createSlabItemTable(p_250829_));
        this.add(Blocks.PRISMARINE_BRICK_SLAB, p_251720_ -> this.createSlabItemTable(p_251720_));
        this.add(Blocks.PRISMARINE_SLAB, p_249342_ -> this.createSlabItemTable(p_249342_));
        ...
        this.add(Blocks.SMOOTH_RED_SANDSTONE_SLAB, p_251340_ -> this.createSlabItemTable(p_251340_));
        this.add(Blocks.MOSSY_STONE_BRICK_SLAB, p_252148_ -> this.createSlabItemTable(p_252148_));
        this.add(Blocks.POLISHED_DIORITE_SLAB, p_248742_ -> this.createSlabItemTable(p_248742_));
        this.add(Blocks.MOSSY_COBBLESTONE_SLAB, p_252320_ -> this.createSlabItemTable(p_252320_));
        this.add(Blocks.END_STONE_BRICK_SLAB, p_249683_ -> this.createSlabItemTable(p_249683_));
        this.add(Blocks.SMOOTH_SANDSTONE_SLAB, p_249813_ -> this.createSlabItemTable(p_249813_));
        this.add(Blocks.SMOOTH_QUARTZ_SLAB, p_250170_ -> this.createSlabItemTable(p_250170_));
        this.add(Blocks.GRANITE_SLAB, p_249068_ -> this.createSlabItemTable(p_249068_));
        this.add(Blocks.ANDESITE_SLAB, p_251963_ -> this.createSlabItemTable(p_251963_));
        this.add(Blocks.RED_NETHER_BRICK_SLAB, p_250291_ -> this.createSlabItemTable(p_250291_));
        this.add(Blocks.POLISHED_ANDESITE_SLAB, p_251741_ -> this.createSlabItemTable(p_251741_));
        this.add(Blocks.DIORITE_SLAB, p_249431_ -> this.createSlabItemTable(p_249431_));
        this.add(Blocks.CRIMSON_SLAB, p_249660_ -> this.createSlabItemTable(p_249660_));
        this.add(Blocks.WARPED_SLAB, p_249229_ -> this.createSlabItemTable(p_249229_));
        this.add(Blocks.BLACKSTONE_SLAB, p_251568_ -> this.createSlabItemTable(p_251568_));
        this.add(Blocks.POLISHED_BLACKSTONE_BRICK_SLAB, p_248799_ -> this.createSlabItemTable(p_248799_));
        this.add(Blocks.POLISHED_BLACKSTONE_SLAB, p_249358_ -> this.createSlabItemTable(p_249358_));
        this.add(Blocks.OXIDIZED_CUT_COPPER_SLAB, p_252044_ -> this.createSlabItemTable(p_252044_));
        this.add(Blocks.WEATHERED_CUT_COPPER_SLAB, p_251336_ -> this.createSlabItemTable(p_251336_));
        this.add(Blocks.EXPOSED_CUT_COPPER_SLAB, p_251951_ -> this.createSlabItemTable(p_251951_));
        this.add(Blocks.CUT_COPPER_SLAB, p_250882_ -> this.createSlabItemTable(p_250882_));
        this.add(Blocks.WAXED_OXIDIZED_CUT_COPPER_SLAB, p_249866_ -> this.createSlabItemTable(p_249866_));
        this.add(Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB, p_252348_ -> this.createSlabItemTable(p_252348_));
        this.add(Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB, p_248980_ -> this.createSlabItemTable(p_248980_));
        this.add(Blocks.WAXED_CUT_COPPER_SLAB, p_277247_ -> this.createSlabItemTable(p_277247_));
        this.add(Blocks.COBBLED_DEEPSLATE_SLAB, p_277242_ -> this.createSlabItemTable(p_277242_));
        this.add(Blocks.POLISHED_DEEPSLATE_SLAB, p_277239_ -> this.createSlabItemTable(p_277239_));
        this.add(Blocks.DEEPSLATE_TILE_SLAB, p_341021_ -> this.createSlabItemTable(p_341021_));
        this.add(Blocks.DEEPSLATE_BRICK_SLAB, p_341042_ -> this.createSlabItemTable(p_341042_));
        this.add(Blocks.MUD_BRICK_SLAB, p_341062_ -> this.createSlabItemTable(p_341062_));
        this.add(Blocks.OAK_DOOR, p_272365_ -> this.createDoorTable(p_272365_));
        this.add(Blocks.SPRUCE_DOOR, p_272370_ -> this.createDoorTable(p_272370_));
        this.add(Blocks.BIRCH_DOOR, p_272372_ -> this.createDoorTable(p_272372_));
        this.add(Blocks.JUNGLE_DOOR, p_272374_ -> this.createDoorTable(p_272374_));
        this.add(Blocks.ACACIA_DOOR, p_272357_ -> this.createDoorTable(p_272357_));
        this.add(Blocks.DARK_OAK_DOOR, p_272359_ -> this.createDoorTable(p_272359_));
        this.add(Blocks.MANGROVE_DOOR, p_272363_ -> this.createDoorTable(p_272363_));
        this.add(Blocks.CHERRY_DOOR, p_272367_ -> this.createDoorTable(p_272367_));
        this.add(Blocks.BAMBOO_DOOR, p_272361_ -> this.createDoorTable(p_272361_));
        this.add(Blocks.WARPED_DOOR, p_272376_ -> this.createDoorTable(p_272376_));
        this.add(Blocks.CRIMSON_DOOR, p_277245_ -> this.createDoorTable(p_277245_));
        this.add(Blocks.IRON_DOOR, p_277250_ -> this.createDoorTable(p_277250_));
        this.add(Blocks.COPPER_DOOR, p_341056_ -> this.createDoorTable(p_341056_));
        this.add(Blocks.EXPOSED_COPPER_DOOR, p_341039_ -> this.createDoorTable(p_341039_));
        this.add(Blocks.WEATHERED_COPPER_DOOR, p_341031_ -> this.createDoorTable(p_341031_));
        this.add(Blocks.OXIDIZED_COPPER_DOOR, p_341037_ -> this.createDoorTable(p_341037_));
        this.add(Blocks.WAXED_COPPER_DOOR, p_341033_ -> this.createDoorTable(p_341033_));
        this.add(Blocks.WAXED_EXPOSED_COPPER_DOOR, p_341054_ -> this.createDoorTable(p_341054_));
        this.add(Blocks.WAXED_WEATHERED_COPPER_DOOR, p_341066_ -> this.createDoorTable(p_341066_));
        this.add(Blocks.WAXED_OXIDIZED_COPPER_DOOR, p_341050_ -> this.createDoorTable(p_341050_));
        this.add(Blocks.BLACK_BED, p_251619_ -> this.createSinglePropConditionTable(p_251619_, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.BLUE_BED, p_250267_ -> this.createSinglePropConditionTable(p_250267_, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.BROWN_BED, p_252081_ -> this.createSinglePropConditionTable(p_252081_, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.CYAN_BED, p_251275_ -> this.createSinglePropConditionTable(p_251275_, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.GRAY_BED, p_252316_ -> this.createSinglePropConditionTable(p_252316_, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.GREEN_BED, p_249155_ -> this.createSinglePropConditionTable(p_249155_, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.LIGHT_BLUE_BED, p_249678_ -> this.createSinglePropConditionTable(p_249678_, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.LIGHT_GRAY_BED, p_250887_ -> this.createSinglePropConditionTable(p_250887_, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.LIME_BED, p_251388_ -> this.createSinglePropConditionTable(p_251388_, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.MAGENTA_BED, p_249449_ -> this.createSinglePropConditionTable(p_249449_, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.PURPLE_BED, p_251562_ -> this.createSinglePropConditionTable(p_251562_, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.ORANGE_BED, p_249639_ -> this.createSinglePropConditionTable(p_249639_, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.PINK_BED, p_248689_ -> this.createSinglePropConditionTable(p_248689_, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.RED_BED, p_252284_ -> this.createSinglePropConditionTable(p_252284_, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.WHITE_BED, p_250939_ -> this.createSinglePropConditionTable(p_250939_, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.YELLOW_BED, p_250517_ -> this.createSinglePropConditionTable(p_250517_, BedBlock.PART, BedPart.HEAD));
        ...
        this.add(Blocks.CANDLE, p_250477_ -> this.createCandleDrops(p_250477_));
        this.add(Blocks.WHITE_CANDLE, p_250214_ -> this.createCandleDrops(p_250214_));
        this.add(Blocks.ORANGE_CANDLE, p_250876_ -> this.createCandleDrops(p_250876_));
        this.add(Blocks.MAGENTA_CANDLE, p_249556_ -> this.createCandleDrops(p_249556_));
        this.add(Blocks.LIGHT_BLUE_CANDLE, p_250463_ -> this.createCandleDrops(p_250463_));
        this.add(Blocks.YELLOW_CANDLE, p_250078_ -> this.createCandleDrops(p_250078_));
        this.add(Blocks.LIME_CANDLE, p_250051_ -> this.createCandleDrops(p_250051_));
        this.add(Blocks.PINK_CANDLE, p_249078_ -> this.createCandleDrops(p_249078_));
        this.add(Blocks.GRAY_CANDLE, p_249133_ -> this.createCandleDrops(p_249133_));
        this.add(Blocks.LIGHT_GRAY_CANDLE, p_251324_ -> this.createCandleDrops(p_251324_));
        this.add(Blocks.CYAN_CANDLE, p_248584_ -> this.createCandleDrops(p_248584_));
        this.add(Blocks.PURPLE_CANDLE, p_251632_ -> this.createCandleDrops(p_251632_));
        this.add(Blocks.BLUE_CANDLE, p_250130_ -> this.createCandleDrops(p_250130_));
        this.add(Blocks.BROWN_CANDLE, p_250337_ -> this.createCandleDrops(p_250337_));
        this.add(Blocks.GREEN_CANDLE, p_250143_ -> this.createCandleDrops(p_250143_));
        this.add(Blocks.RED_CANDLE, p_252244_ -> this.createCandleDrops(p_252244_));
        this.add(Blocks.BLACK_CANDLE, p_248975_ -> this.createCandleDrops(p_248975_));
        ...
        this.add(Blocks.NETHER_SPROUTS, p_251652_ -> BlockLootSubProvider.createShearsOnlyDrop(p_251652_));
        this.add(Blocks.SEAGRASS, p_250181_ -> BlockLootSubProvider.createShearsOnlyDrop(p_250181_));
        this.add(Blocks.VINE, p_249748_ -> BlockLootSubProvider.createShearsOnlyDrop(p_249748_));
        this.add(Blocks.GLOW_LICHEN, p_249543_ -> this.createMultifaceBlockDrops(p_249543_, HAS_SHEARS));
        this.add(Blocks.HANGING_ROOTS, p_252041_ -> BlockLootSubProvider.createShearsOnlyDrop(p_252041_));
        this.add(Blocks.SMALL_DRIPLEAF, p_250387_ -> BlockLootSubProvider.createShearsOnlyDrop(p_250387_));
        this.add(Blocks.MANGROVE_LEAVES, p_250055_ -> this.createMangroveLeavesDrops(p_250055_));
                                ...
                                AlternativesEntry.alternatives(
                                    AlternativesEntry.alternatives(
                                            ...
                                            p_252097_ -> LootItem.lootTableItem(Items.SNOWBALL)
                                                    .when(
                                                        LootItemBlockStatePropertyCondition.hasBlockStateProperties(p_341027_)
        ...
        this.add(
            ...
            p_341029_ -> this.createSilkTouchDispatchTable(
                    p_341029_,
                    LootItem.lootTableItem(Items.AMETHYST_SHARD)
                        ...
                        .otherwise(
                            (LootPoolEntryContainer.Builder<?>)this.applyExplosionDecay(
                                p_341029_, LootItem.lootTableItem(Items.AMETHYST_SHARD).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F)))
                            )
                        )
                )
        );
