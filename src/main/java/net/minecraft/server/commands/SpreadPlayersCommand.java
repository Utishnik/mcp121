                                            ...
                                            Commands.argument("respectTeams", BoolArgumentType.bool())
                                                .then(
                                                    Commands.argument("targets", EntityArgument.entities())
                                                        .executes(
                                                            p_326344_ -> spreadPlayers(
                                                                    p_326344_.getSource(),
                                                                    Vec2Argument.getVec2(p_326344_, "center"),
                                                                    FloatArgumentType.getFloat(p_326344_, "spreadDistance"),
                                                                    FloatArgumentType.getFloat(p_326344_, "maxRange"),
                                                                    p_326344_.getSource().getLevel().getMaxBuildHeight(),
                                                                    BoolArgumentType.getBool(p_326344_, "respectTeams"),
                                                                    EntityArgument.getEntities(p_326344_, "targets")
                                                                )
                                                        )
                                                )
                                        )
