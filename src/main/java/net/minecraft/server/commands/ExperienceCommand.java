...
public class ExperienceCommand {
    ...
    static enum Type {
        POINTS("points", Player::giveExperiencePoints, (p_341170_, p_341171_) -> {
            if (p_341171_ >= p_341170_.getXpNeededForNextLevel()) {
                return false;
            } else {
                p_341170_.setExperiencePoints(p_341171_);
                return true;
            }
        }, p_341172_ -> Mth.floor(p_341172_.experienceProgress * (float)p_341172_.getXpNeededForNextLevel())),
