        ...
        this.goalSelector
            .addGoal(
                ...
                new UseItemGoal<>(
                    ...
                    p_341477_ -> this.level().isNight() && !p_341477_.isInvisible()
                )
            );
        this.goalSelector
            .addGoal(
                0, new UseItemGoal<>(this, new ItemStack(Items.MILK_BUCKET), SoundEvents.WANDERING_TRADER_REAPPEARED, p_341478_ -> this.level().isDay() && p_341478_.isInvisible())
            );
            ...
            if (blockpos != null && WanderingTrader.this.navigation.isDone()) {
                if (this.isTooFarAway(blockpos, 10.0)) {
                    ...
                    WanderingTrader.this.navigation
                        .moveTo((double)blockpos.getX(), (double)blockpos.getY(), (double)blockpos.getZ(), this.speedModifier);
                }
            }
        }
