...
public class StackedContents {
    ...
    public int getBiggestCraftableStack(RecipeHolder<?> p_301008_, @Nullable IntList p_36495_) {
        return this.getBiggestCraftableStack(p_301008_, Integer.MAX_VALUE, p_36495_);
    }

    public int getBiggestCraftableStack(RecipeHolder<?> p_299486_, int p_36473_, @Nullable IntList p_36474_) {
        return new StackedContents.RecipePicker(p_299486_.value()).tryPickAll(p_36473_, p_36474_);
    }
    ...
    class RecipePicker {
        ...
        public RecipePicker(final Recipe<?> p_36508_) {
                    ...
                    if (flag1 && ingredient.isEmpty()) {
                        ...
                        for (int i1 = 0; i1 < this.itemCount; i1++) {
                            if (this.hasResidual(false, l, i1)) {
                                ...
                                StackedContents.this.put(this.items[i1], p_36513_);
                                if (flag1) {
                                    p_36514_.add(this.items[i1]);
                                }
                            }
                        }
