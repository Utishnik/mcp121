    ...
    public static OneShot<Mob> create(int p_259782_, float p_259071_) {
        return BehaviorBuilder.create(
            p_260278_ -> p_260278_.group(
                    ...
                    .apply(
                        p_260278_,
                        (p_260206_, p_259953_, p_259993_, p_259209_) -> (p_259617_, p_260038_, p_259374_) -> {
                                LivingEntity livingentity = p_260278_.get(p_259993_);
                                if (livingentity.closerThan(p_260038_, (double)p_259782_)
                                    && p_260278_.<NearestVisibleLivingEntities>get(p_259209_).contains(livingentity)) {
