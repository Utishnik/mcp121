...
public class LandRandomPos {
        ...
        return RandomPos.generateRandomPos(
            ...
            () -> {
                BlockPos blockpos = RandomPos.generateRandomDirectionWithinRadians(
                    p_148498_.getRandom(), p_148499_, p_148500_, 0, p_148501_.x, p_148501_.z, (float) (Math.PI / 2)
                );
                if (blockpos == null) {
                    return null;
                } else {
    ...
    public static BlockPos movePosUpOutOfSolid(PathfinderMob p_148519_, BlockPos p_148520_) {
        p_148520_ = RandomPos.moveUpOutOfSolid(p_148520_, p_148519_.level().getMaxBuildHeight(), p_148534_ -> GoalUtils.isSolid(p_148519_, p_148534_));
