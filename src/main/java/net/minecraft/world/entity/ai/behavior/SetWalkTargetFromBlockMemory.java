    ...
    public static OneShot<Villager> create(MemoryModuleType<GlobalPos> p_259685_, float p_259842_, int p_259530_, int p_260360_, int p_259504_) {
        return BehaviorBuilder.create(
            p_258717_ -> p_258717_.group(
                        p_258717_.registered(MemoryModuleType.CANT_REACH_WALK_TARGET_SINCE), p_258717_.absent(MemoryModuleType.WALK_TARGET), p_258717_.present(p_259685_)
                    )
                    .apply(
                        p_258717_,
                        (p_258709_, p_258710_, p_258711_) -> (p_275056_, p_275057_, p_275058_) -> {
                                ...
                                if (globalpos.dimension() == p_275056_.dimension()
                                    && (!optional.isPresent() || p_275056_.getGameTime() - optional.get() <= (long)p_259504_)) {
                                    if (globalpos.pos().distManhattan(p_275057_.blockPosition()) > p_260360_) {
                                        ...
                                        while (vec3 == null || BlockPos.containing(vec3).distManhattan(p_275057_.blockPosition()) > p_260360_) {
                                            vec3 = DefaultRandomPos.getPosTowards(p_275057_, 15, 7, Vec3.atBottomCenterOf(globalpos.pos()), (float) (Math.PI / 2));
                                            if (++i == 1000) {
