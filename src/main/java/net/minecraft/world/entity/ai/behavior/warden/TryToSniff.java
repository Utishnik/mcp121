    ...
    public static BehaviorControl<LivingEntity> create() {
        return BehaviorBuilder.create(
            p_259979_ -> p_259979_.group(
                    ...
                    .apply(p_259979_, (p_260219_, p_260252_, p_260090_, p_259577_, p_260020_) -> (p_326924_, p_326925_, p_326926_) -> {
                            p_260219_.set(Unit.INSTANCE);
                            p_260090_.setWithExpiry(Unit.INSTANCE, (long)SNIFF_COOLDOWN.sample(p_326924_.getRandom()));
                            p_260252_.erase();
                            p_326925_.setPose(Pose.SNIFFING);
                            return true;
                        })
        );
    }
