    ...
    public static OneShot<Mob> create(int p_259758_) {
        return BehaviorBuilder.create(
            p_258526_ -> p_258526_.group(
                        ...
                        p_258526_.present(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES)
                    )
                    .apply(
                        p_258526_,
                        (p_258529_, p_258530_, p_258531_, p_258532_) -> (p_258539_, p_258540_, p_258541_) -> {
                                LivingEntity livingentity = p_258526_.get(p_258530_);
                                if (!isHoldingUsableProjectileWeapon(p_258540_)
                                    && p_258540_.isWithinMeleeAttackRange(livingentity)
                                    && p_258526_.<NearestVisibleLivingEntities>get(p_258532_).contains(livingentity)) {
