        ...
        if (!(p_166053_ - p_166050_ < 1.0E-7) && !(p_166054_ - p_166051_ < 1.0E-7) && !(p_166055_ - p_166052_ < 1.0E-7)) {
            ...
            if (i < 0 || j < 0 || k < 0) {
                ...
                BitSetDiscreteVoxelShape bitsetdiscretevoxelshape = BitSetDiscreteVoxelShape.withFilledBounds(
                    ...
                    i1,
                    j1,
                    (int)Math.round(p_166050_ * (double)l),
                    (int)Math.round(p_166051_ * (double)i1),
                    (int)Math.round(p_166052_ * (double)j1),
                    (int)Math.round(p_166053_ * (double)l),
                    (int)Math.round(p_166054_ * (double)i1),
                    (int)Math.round(p_166055_ * (double)j1)
                );
    ...
    public static VoxelShape getFaceShape(VoxelShape p_83122_, Direction p_83123_) {
        if (p_83122_ == block()) {
            ...
            if (p_83123_.getAxisDirection() == Direction.AxisDirection.POSITIVE) {
                flag = DoubleMath.fuzzyEquals(p_83122_.max(direction$axis), 1.0, 1.0E-7);
                i = p_83122_.shape.getSize(direction$axis) - 1;
            } else {
                flag = DoubleMath.fuzzyEquals(p_83122_.min(direction$axis), 0.0, 1.0E-7);
                i = 0;
            }
