...
public final class DensityFunctions {
    ...
    protected static record Noise(DensityFunction.NoiseHolder noise, @Deprecated double xzScale, double yScale) implements DensityFunction {
        ...
        public double compute(DensityFunction.FunctionContext p_208800_) {
            return this.noise
                .getValue(
                    (double)p_208800_.blockX() * this.xzScale,
                    (double)p_208800_.blockY() * this.yScale,
                    (double)p_208800_.blockZ() * this.xzScale
                );
        }
    ...
    protected static record WeirdScaledSampler(
        ...
        public double transform(DensityFunction.FunctionContext p_208440_, double p_208441_) {
            ...
            return d0
                * Math.abs(this.noise.getValue((double)p_208440_.blockX() / d0, (double)p_208440_.blockY() / d0, (double)p_208440_.blockZ() / d0));
        }
