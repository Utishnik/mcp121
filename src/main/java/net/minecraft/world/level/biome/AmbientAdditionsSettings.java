...
public class AmbientAdditionsSettings {
    public static final Codec<AmbientAdditionsSettings> CODEC = RecordCodecBuilder.create(
        p_47382_ -> p_47382_.group(
                    SoundEvent.CODEC.fieldOf("sound").forGetter(p_151642_ -> p_151642_.soundEvent),
                    Codec.DOUBLE.fieldOf("tick_chance").forGetter(p_151640_ -> p_151640_.tickChance)
                )
