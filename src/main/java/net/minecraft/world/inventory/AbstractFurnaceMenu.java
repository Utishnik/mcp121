...
public abstract class AbstractFurnaceMenu extends RecipeBookMenu<SingleRecipeInput, AbstractCookingRecipe> {
    ...
    @Override
    public boolean recipeMatches(RecipeHolder<AbstractCookingRecipe> p_297720_) {
        return p_297720_.value().matches(new SingleRecipeInput(this.container.getItem(0)), this.level);
    }
