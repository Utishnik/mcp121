...
public class SimpleSoundInstance extends AbstractSoundInstance {
    ...
    public static SimpleSoundInstance forMusic(SoundEvent p_119746_) {
        return new SimpleSoundInstance(
            p_119746_.getLocation(), SoundSource.MUSIC, 1.0F, 1.0F, SoundInstance.createUnseededRandom(), false, 0, SoundInstance.Attenuation.NONE, 0.0, 0.0, 0.0, true
        );
    }
