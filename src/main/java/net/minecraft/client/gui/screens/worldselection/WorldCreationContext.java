...
public record WorldCreationContext(
    ...
    public WorldCreationContext withDimensions(WorldCreationContext.DimensionsUpdater p_250676_) {
        return new WorldCreationContext(
            this.options, this.datapackDimensions, p_250676_.apply(this.worldgenLoadContext(), this.selectedDimensions), this.worldgenRegistries, this.dataPackResources, this.dataConfiguration
        );
    }
