    ...
    public static FaviconTexture forWorld(TextureManager p_289550_, String p_289565_) {
        return new FaviconTexture(
            ...
            ResourceLocation.withDefaultNamespace(
                "worlds/" + Util.sanitizeName(p_289565_, ResourceLocation::validPathChar) + "/" + Hashing.sha1().hashUnencodedChars(p_289565_) + "/icon"
            )
        );
    }

    public static FaviconTexture forServer(TextureManager p_289553_, String p_289535_) {
        return new FaviconTexture(p_289553_, ResourceLocation.withDefaultNamespace("servers/" + Hashing.sha1().hashUnencodedChars(p_289535_) + "/icon"));
    }
