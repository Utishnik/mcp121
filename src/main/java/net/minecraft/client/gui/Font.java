...
public class Font {
    ...
    private float renderText(
        ...
        Font.StringRenderOutput font$stringrenderoutput = new Font.StringRenderOutput(
            p_272595_, p_273532_, p_272783_, p_273217_, p_273583_, p_272734_, p_273610_, p_273199_
        );
    ...
    private float renderText(
        ...
        Font.StringRenderOutput font$stringrenderoutput = new Font.StringRenderOutput(
            p_273392_, p_272632_, p_273541_, p_273200_, p_273312_, p_273276_, p_272625_, p_273371_
        );
    ...
    class StringRenderOutput implements FormattedCharSink {
        ...
        public boolean accept(int p_92967_, Style p_92968_, int p_92969_) {
            ...
            if (p_92968_.isStrikethrough()) {
                this.addEffect(
                    new BakedGlyph.Effect(
                        this.x + f7 - 1.0F, this.y + f7 + 4.5F, this.x + f7 + f6, this.y + f7 + 4.5F - 1.0F, 0.01F, f, f1, f2, f3
                    )
                );
            }
            ...
            if (p_92968_.isUnderlined()) {
                this.addEffect(
                    new BakedGlyph.Effect(
                        this.x + f7 - 1.0F, this.y + f7 + 9.0F, this.x + f7 + f6, this.y + f7 + 9.0F - 1.0F, 0.01F, f, f1, f2, f3
                    )
                );
            }
        ...
        public float finish(int p_92962_, float p_92963_) {
            if (p_92962_ != 0) {
                float f = (float)(p_92962_ >> 24 & 0xFF) / 255.0F;
                float f1 = (float)(p_92962_ >> 16 & 0xFF) / 255.0F;
                float f2 = (float)(p_92962_ >> 8 & 0xFF) / 255.0F;
                float f3 = (float)(p_92962_ & 0xFF) / 255.0F;
