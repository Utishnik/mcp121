...
public abstract class AgeableHierarchicalModel<E extends Entity> extends HierarchicalModel<E> {
    ...
    @Override
    public void renderToBuffer(PoseStack p_273029_, VertexConsumer p_272763_, int p_273665_, int p_272602_, int p_345249_) {
        if (this.young) {
            p_273029_.pushPose();
            ...
            this.root().render(p_273029_, p_272763_, p_273665_, p_272602_, p_345249_);
            p_273029_.popPose();
        } else {
            this.root().render(p_273029_, p_272763_, p_273665_, p_272602_, p_345249_);
        }
