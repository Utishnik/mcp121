...
public class HumanoidModel<T extends LivingEntity> extends AgeableListModel<T> implements ArmedModel, HeadedModel {
    ...
    public static MeshDefinition createMesh(CubeDeformation p_170682_, float p_170683_) {
        ...
        partdefinition.addOrReplaceChild(
            "hat",
            CubeListBuilder.create().texOffs(32, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, p_170682_.extend(0.5F)),
            PartPose.offset(0.0F, 0.0F + p_170683_, 0.0F)
        );
        partdefinition.addOrReplaceChild(
            "body",
        ...
        switch (this.rightArmPose) {
            ...
            case SPYGLASS:
                this.rightArm.xRot = Mth.clamp(
                    this.head.xRot - 1.9198622F - (p_102876_.isCrouching() ? (float) (Math.PI / 12) : 0.0F), -2.4F, 3.3F
                );
        ...
        switch (this.leftArmPose) {
            ...
            case SPYGLASS:
                this.leftArm.xRot = Mth.clamp(
                    this.head.xRot - 1.9198622F - (p_102879_.isCrouching() ? (float) (Math.PI / 12) : 0.0F), -2.4F, 3.3F
                );
