...
public class CamelModel<T extends Camel> extends HierarchicalModel<T> {
    ...
    @Override
    public void renderToBuffer(PoseStack p_250278_, VertexConsumer p_251678_, int p_249298_, int p_251841_, int p_343890_) {
        if (this.young) {
            p_250278_.pushPose();
            p_250278_.scale(0.45F, 0.45F, 0.45F);
            p_250278_.translate(0.0F, 1.834375F, 0.0F);
            this.root().render(p_250278_, p_251678_, p_249298_, p_251841_, p_343890_);
            p_250278_.popPose();
        } else {
            this.root().render(p_250278_, p_251678_, p_249298_, p_251841_, p_343890_);
        }
