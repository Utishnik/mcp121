...
public class ArmadilloModel extends AgeableHierarchicalModel<Armadillo> {
    ...
    public void setupAnim(Armadillo p_331950_, float p_336282_, float p_330081_, float p_331623_, float p_333282_, float p_333013_) {
        ...
        if (p_331950_.shouldHideInShell()) {
            ...
            this.head.xRot = Mth.clamp(p_333013_, -22.5F, 25.0F) * (float) (Math.PI / 180.0);
            this.head.yRot = Mth.clamp(p_333282_, -32.5F, 32.5F) * (float) (Math.PI / 180.0);
        }

        this.animateWalk(ArmadilloAnimation.ARMADILLO_WALK, p_336282_, p_330081_, 16.5F, 2.5F);
        this.animate(p_331950_.rollOutAnimationState, ArmadilloAnimation.ARMADILLO_ROLL_OUT, p_331623_, 1.0F);
        this.animate(p_331950_.rollUpAnimationState, ArmadilloAnimation.ARMADILLO_ROLL_UP, p_331623_, 1.0F);
        this.animate(p_331950_.peekAnimationState, ArmadilloAnimation.ARMADILLO_PEEK, p_331623_, 1.0F);
    }
}