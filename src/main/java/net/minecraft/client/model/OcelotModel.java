...
public class OcelotModel<T extends Entity> extends AgeableListModel<T> {
    ...
    public static MeshDefinition createBodyMesh(CubeDeformation p_170769_) {
        ...
        partdefinition.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                ...
                .addBox("nose", -1.5F, -0.001F, -4.0F, 3, 2, 2, p_170769_, 0, 24)
        ...
        partdefinition.addOrReplaceChild(
            "body",
            CubeListBuilder.create().texOffs(20, 0).addBox(-2.0F, 3.0F, -8.0F, 4.0F, 16.0F, 6.0F, p_170769_),
            PartPose.offsetAndRotation(0.0F, 12.0F, -10.0F, (float) (Math.PI / 2), 0.0F, 0.0F)
        );
        partdefinition.addOrReplaceChild(
            "tail1",
            CubeListBuilder.create().texOffs(0, 15).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 8.0F, 1.0F, p_170769_),
    ...
    public void setupAnim(T p_103147_, float p_103148_, float p_103149_, float p_103150_, float p_103151_, float p_103152_) {
        this.head.xRot = p_103152_ * (float) (Math.PI / 180.0);
        this.head.yRot = p_103151_ * (float) (Math.PI / 180.0);
        if (this.state != 3) {
            ...
            if (this.state == 2) {
                ...
                this.tail2.xRot = 1.7278761F + (float) (Math.PI / 10) * Mth.cos(p_103148_) * p_103149_;
            } else {
                this.leftHindLeg.xRot = Mth.cos(p_103148_ * 0.6662F) * p_103149_;
                ...
                if (this.state == 1) {
                    this.tail2.xRot = 1.7278761F + (float) (Math.PI / 4) * Mth.cos(p_103148_) * p_103149_;
                } else {
