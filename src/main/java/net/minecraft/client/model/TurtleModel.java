...
public class TurtleModel<T extends Turtle> extends QuadrupedModel<T> {
    ...
    @Override
    public void renderToBuffer(PoseStack p_104001_, VertexConsumer p_104002_, int p_104003_, int p_104004_, int p_344536_) {
        ...
        super.renderToBuffer(p_104001_, p_104002_, p_104003_, p_104004_, p_344536_);
        if (flag) {
            p_104001_.popPose();
        }
    }
