...
public class RabbitModel<T extends Rabbit> extends EntityModel<T> {
    ...
    @Override
    public void renderToBuffer(PoseStack p_103555_, VertexConsumer p_103556_, int p_103557_, int p_103558_, int p_345136_) {
        if (this.young) {
            float f = 1.5F;
            p_103555_.pushPose();
            ...
            ImmutableList.of(this.head, this.leftEar, this.rightEar, this.nose)
                .forEach(p_340882_ -> p_340882_.render(p_103555_, p_103556_, p_103557_, p_103558_, p_345136_));
            p_103555_.popPose();
            p_103555_.pushPose();
            ...
            ImmutableList.of(this.leftRearFoot, this.rightRearFoot, this.leftHaunch, this.rightHaunch, this.body, this.leftFrontLeg, this.rightFrontLeg, this.tail)
                .forEach(p_340888_ -> p_340888_.render(p_103555_, p_103556_, p_103557_, p_103558_, p_345136_));
            p_103555_.popPose();
        } else {
            p_103555_.pushPose();
            ...
            ImmutableList.of(
                ...
                .forEach(p_340876_ -> p_340876_.render(p_103555_, p_103556_, p_103557_, p_103558_, p_345136_));
            p_103555_.popPose();
        }
    }
    ...
    public void setupAnim(T p_103548_, float p_103549_, float p_103550_, float p_103551_, float p_103552_, float p_103553_) {
        ...
        this.nose.xRot = p_103553_ * (float) (Math.PI / 180.0);
        this.head.xRot = p_103553_ * (float) (Math.PI / 180.0);
        this.rightEar.xRot = p_103553_ * (float) (Math.PI / 180.0);
        this.leftEar.xRot = p_103553_ * (float) (Math.PI / 180.0);
        this.nose.yRot = p_103552_ * (float) (Math.PI / 180.0);
        this.head.yRot = p_103552_ * (float) (Math.PI / 180.0);
