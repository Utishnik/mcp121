...
public class LocalPlayer extends AbstractClientPlayer {
    ...
    public void removeRecipeHighlight(RecipeHolder<?> p_299313_) {
        if (this.recipeBook.willHighlight(p_299313_)) {
            this.recipeBook.removeHighlight(p_299313_);
            this.connection.send(new ServerboundRecipeBookSeenRecipePacket(p_299313_));
        }
    }
