...
public class SquidInkParticle extends SimpleAnimatedParticle {
    ...
    public static class GlowInkProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            return new SquidInkParticle(
                p_172348_, p_172349_, p_172350_, p_172351_, p_172352_, p_172353_, p_172354_, FastColor.ARGB32.color(255, 204, 31, 102), this.sprites
            );
        }
    }
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            return new SquidInkParticle(
                p_108003_, p_108004_, p_108005_, p_108006_, p_108007_, p_108008_, p_108009_, FastColor.ARGB32.color(255, 255, 255, 255), this.sprites
            );
        }
    }
}