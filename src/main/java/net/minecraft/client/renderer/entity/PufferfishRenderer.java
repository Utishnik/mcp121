...
public class PufferfishRenderer extends MobRenderer<Pufferfish, EntityModel<Pufferfish>> {
    ...
    protected void setupRotations(Pufferfish p_115784_, PoseStack p_115785_, float p_115786_, float p_115787_, float p_115788_, float p_336044_) {
        p_115785_.translate(0.0F, Mth.cos(p_115786_ * 0.05F) * 0.08F, 0.0F);
        super.setupRotations(p_115784_, p_115785_, p_115786_, p_115787_, p_115788_, p_336044_);
    }
}