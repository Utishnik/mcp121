...
public abstract class RenderLayer<T extends Entity, M extends EntityModel<T>> {
    ...
    protected static <T extends LivingEntity> void coloredCutoutModelCopyLayerRender(
        ...
        if (!p_117366_.isInvisible()) {
            ...
            renderColoredCutoutModel(p_117361_, p_117362_, p_117363_, p_117364_, p_117365_, p_117366_, p_345259_);
        }
    }

    protected static <T extends LivingEntity> void renderColoredCutoutModel(
        EntityModel<T> p_117377_, ResourceLocation p_117378_, PoseStack p_117379_, MultiBufferSource p_117380_, int p_117381_, T p_117382_, int p_343754_
    ) {
        VertexConsumer vertexconsumer = p_117380_.getBuffer(RenderType.entityCutoutNoCull(p_117378_));
        p_117377_.renderToBuffer(p_117379_, vertexconsumer, p_117381_, LivingEntityRenderer.getOverlayCoords(p_117382_, 0.0F), p_343754_);
    }
