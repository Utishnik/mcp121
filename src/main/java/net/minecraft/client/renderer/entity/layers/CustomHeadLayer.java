...
public class CustomHeadLayer<T extends LivingEntity, M extends EntityModel<T> & HeadedModel> extends RenderLayer<T, M> {
    ...
    public CustomHeadLayer(
        RenderLayerParent<T, M> p_234822_, EntityModelSet p_234823_, float p_234824_, float p_234825_, float p_234826_, ItemInHandRenderer p_234827_
    ) {
        super(p_234822_);
    ...
    public void render(
        ...
        if (!itemstack.isEmpty()) {
            ...
            if (item instanceof BlockItem && ((BlockItem)item).getBlock() instanceof AbstractSkullBlock) {
                ...
                if (p_116734_.getVehicle() instanceof LivingEntity livingentity) {
