...
public class PandaRenderer extends MobRenderer<Panda, PandaModel<Panda>> {
    ...
    protected void setupRotations(Panda p_115641_, PoseStack p_115642_, float p_115643_, float p_115644_, float p_115645_, float p_331784_) {
        super.setupRotations(p_115641_, p_115642_, p_115643_, p_115644_, p_115645_, p_331784_);
        ...
        if (f6 > 0.0F) {
            ...
            if (p_115641_.isScared()) {
                float f7 = (float)(Math.cos((double)p_115641_.tickCount * 1.25) * Math.PI * 0.05F);
