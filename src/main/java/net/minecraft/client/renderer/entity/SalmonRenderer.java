...
public class SalmonRenderer extends MobRenderer<Salmon, SalmonModel<Salmon>> {
    ...
    protected void setupRotations(Salmon p_115828_, PoseStack p_115829_, float p_115830_, float p_115831_, float p_115832_, float p_329335_) {
        super.setupRotations(p_115828_, p_115829_, p_115830_, p_115831_, p_115832_, p_329335_);
        float f = 1.0F;
        float f1 = 1.0F;
