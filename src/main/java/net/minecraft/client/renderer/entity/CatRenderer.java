...
public class CatRenderer extends MobRenderer<Cat, CatModel<Cat>> {
    ...
    protected void setupRotations(Cat p_113956_, PoseStack p_113957_, float p_113958_, float p_113959_, float p_113960_, float p_328718_) {
        super.setupRotations(p_113956_, p_113957_, p_113958_, p_113959_, p_113960_, p_328718_);
        ...
        if (f > 0.0F) {
            ...
            for (Player player : p_113956_.level().getEntitiesOfClass(Player.class, new AABB(blockpos).inflate(2.0, 2.0, 2.0))) {
