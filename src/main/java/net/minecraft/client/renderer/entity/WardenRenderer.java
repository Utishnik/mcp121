...
public class WardenRenderer extends MobRenderer<Warden, WardenModel<Warden>> {
    ...
    public WardenRenderer(EntityRendererProvider.Context p_234787_) {
        ...
        this.addLayer(new WardenEmissiveLayer<>(this, BIOLUMINESCENT_LAYER_TEXTURE, (p_234809_, p_234810_, p_234811_) -> 1.0F, WardenModel::getBioluminescentLayerModelParts));
        this.addLayer(
            new WardenEmissiveLayer<>(
                this, PULSATING_SPOTS_TEXTURE_1, (p_234805_, p_234806_, p_234807_) -> Math.max(0.0F, Mth.cos(p_234807_ * 0.045F) * 0.25F), WardenModel::getPulsatingSpotsLayerModelParts
            )
        );
        this.addLayer(
            new WardenEmissiveLayer<>(
                ...
                (p_234801_, p_234802_, p_234803_) -> Math.max(0.0F, Mth.cos(p_234803_ * 0.045F + (float) Math.PI) * 0.25F),
                WardenModel::getPulsatingSpotsLayerModelParts
            )
        );
        this.addLayer(new WardenEmissiveLayer<>(this, TEXTURE, (p_234797_, p_234798_, p_234799_) -> p_234797_.getTendrilAnimation(p_234798_), WardenModel::getTendrilsLayerModelParts));
        this.addLayer(new WardenEmissiveLayer<>(this, HEART_TEXTURE, (p_234793_, p_234794_, p_234795_) -> p_234793_.getHeartAnimation(p_234794_), WardenModel::getHeartLayerModelParts));
    }
