...
public class PostChain implements AutoCloseable {
    ...
    public PostChain(TextureManager p_110018_, ResourceProvider p_330521_, RenderTarget p_110020_, ResourceLocation p_110021_) throws IOException, JsonSyntaxException {
        this.resourceProvider = p_330521_;
    ...
    public PostPass addPass(String p_110043_, RenderTarget p_110044_, RenderTarget p_110045_, boolean p_328451_) throws IOException {
        PostPass postpass = new PostPass(this.resourceProvider, p_110043_, p_110044_, p_110045_, p_328451_);
    ...
    private void setFilterMode(int p_332067_) {
