...
public abstract class RenderStateShard {
    ...
    protected static final RenderStateShard.ShaderStateShard RENDERTYPE_CLOUDS_SHADER = new RenderStateShard.ShaderStateShard(GameRenderer::getRendertypeCloudsShader);
    ...
    protected static final RenderStateShard.OutputStateShard OUTLINE_TARGET = new RenderStateShard.OutputStateShard(
        "outline_target", () -> Minecraft.getInstance().levelRenderer.entityTarget().bindWrite(false), () -> Minecraft.getInstance().getMainRenderTarget().bindWrite(false)
    );
    ...
    protected static class ShaderStateShard extends RenderStateShard {
        ...
        public ShaderStateShard(Supplier<ShaderInstance> p_173139_) {
            super("shader", () -> RenderSystem.setShader(p_173139_), () -> {
            });
