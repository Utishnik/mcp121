...
public class ViewArea {
            ...
            for (int j = 0; j < this.sectionGridSizeX; j++) {
                for (int k = 0; k < this.sectionGridSizeY; k++) {
                    for (int l = 0; l < this.sectionGridSizeZ; l++) {
                        ...
                        this.sections[i1] = p_299921_.new RenderSection(i1, j * 16, this.level.getMinBuildHeight() + k * 16, l * 16);
                    }
                }
            }
        }
    ...
    protected SectionRenderDispatcher.RenderSection getRenderSectionAt(BlockPos p_299271_) {
        ...
        if (i >= 0 && i < this.sectionGridSizeY) {
            ...
            int k = Mth.positiveModulo(Mth.floorDiv(p_299271_.getZ(), 16), this.sectionGridSizeZ);
