...
public class RealmsResetNormalWorldScreen extends RealmsScreen {
    ...
    public void init() {
        ...
        linearlayout1.addChild(Button.builder(this.buttonTitle, p_296074_ -> this.callback.accept(this.createWorldGenerationInfo())).build());
        linearlayout1.addChild(Button.builder(CommonComponents.GUI_BACK, p_89288_ -> this.onClose()).build());
        this.layout.visitWidgets(p_325154_ -> {
            AbstractWidget abstractwidget = this.addRenderableWidget(p_325154_);
        });
    ...
    private void createExperimentsButton(LinearLayout p_310633_) {
        ...
        p_310633_.addChild(
            Button.builder(
                    ...
                    p_308065_ -> this.minecraft.setScreen(new ExperimentsScreen(this, packrepository, p_308063_ -> {
